			...
			child:new Container(
				...
				child:ProviderWidget<LoginModel>(
					...
					builder: (context, model, child)=>Column(
						children: <Widget>[
							new Container(
								padding: EdgeInsets.symmetric(horizontal: ScreenUtil().setWidth(74),vertical: ScreenUtil().setHeight(4)),
								decoration: BoxDecoration(
									border: Border(
										bottom: BorderSide(
											width: 2,
					...
					child: Container(
						...
						child: FlatButton(
							onPressed: () {
								...
								model.fetchModifyPassword(this._phoneNumber, this._checkCode,this._password)
									.then((value) {
										if (value) {
											var yyDialog;
