...
class TakeItem extends StatelessWidget {
  ...
  final SpecimenBoxTakeModel model;
  TakeItem({this.item, this.model});
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
                ...
                child: Text('交接时间：${item.receiveAt}',
                    style: TextStyle(
                        fontSize: ScreenUtil().setSp(38),
            ...
            Container(
                margin: EdgeInsets.only(
                    ...
                    left: ScreenUtil().setWidth(40),
                    top: ScreenUtil().setWidth(20)),
                child: Text('备注：${item.pickUpRemark}',
                    maxLines: 2,
                ...
                children: <Widget>[
                  InkWell(
                      ...
                      child: Container(
                        ...
                        child: Text(item.status == 3 ? '已接收' : '确认接收',
                            style: TextStyle(
                                fontSize: ScreenUtil().setSp(38),
                                color: item.status == 3
                                    ? Color(0xFF999999)
