...
class _MineState extends State<Mine>{
	...
	Map<String,dynamic> _dataAccount={'allApply':0,'toBeServedApply':0,'event':0};
		...
		return Offstage(
			...
			child: new PhysicalModel(
				...
				child: new Row(
					...
					children: <Widget>[
					_mineDataItem(number: _dataAccount['allApply'].toString(), type: '全部标本'),
					_mineDataItem(number: _dataAccount['toBeServedApply'].toString(), type: '待送达标本'),
					_mineDataItem(number: _dataAccount['event'].toString(), type: '相关事件'),
					],
				),
				),
			),
