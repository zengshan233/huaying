...
public class SelectPicsActivity extends BaseActivity {
    ...
    public static final String COMPRESS_QUALITY = "COMPRESS_QUALITY";//压缩质量
    ...
    public void onCreate(@androidx.annotation.Nullable Bundle savedInstanceState) {
        ...
        compressQuality = getIntent().getIntExtra(COMPRESS_QUALITY,100);
    ...
    private void lubanCompress(final List<String> paths) {
        ...
        for (int i = 0; i < paths.size(); i++) {
            ...
            Compress.with(this, new File(file))
                    .setTargetDir(getPath())
                    .setQuality(compressQuality)
                    .strategy(Strategies.luban())
                    .setIgnoreSize(compressSize.intValue(),true)
                    .setCompressListener(new CompressListener() {
                        ...
                        public void onSuccess(File result) {
                            // 压缩成功后调用，返回压缩后的图片文件
                            Map<String, String> map = new HashMap<>();
                            map.put("thumbPath", result.getAbsolutePath());
                            map.put("path", result.getAbsolutePath());
