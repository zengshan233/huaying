...
const String _devUrl = "https://lrp-dev.idaoben.com:15443"; //开发环境
...
class FlavorConfig {
  ...
  factory FlavorConfig({@required Flavor flavor}) {
    _instance ??= FlavorConfig._internal(
        ...
        getColor(flavor),
        getImgPre(flavor),
        getBuglyAndroidID(flavor),
        getBuglyiOSID(flavor));
    return _instance;
  }

  FlavorConfig._internal(this.flavor, this.name, this.apiHost, this.appName,
      this.color, this.imgPre, this.buglyAndroid, this.buglyiOS);
