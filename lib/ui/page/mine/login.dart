...
class _LoginState extends State<Login>{
				...
				children: <Widget>[
					new PhysicalModel(
						...
						child: new Container(
							...
							child:new Image(
								image: NetworkImage('http://www.dongdao.net/d/file/logo/2018-04-25/2659ce3f5669af75e07409daee057472.jpg'),
								fit: BoxFit.contain,
							) ,
						)
					),
												...
												new Positioned(
													...
													child: new Container(
														...
														child: new FlatButton(
															color: _sendButtonEnble?Color.fromRGBO(35, 177, 250, 1):Colors.grey.withOpacity(0.1),
															highlightColor: _sendButtonEnble?Colors.blue[700]:Colors.transparent,
															colorBrightness: Brightness.dark,
															splashColor: _sendButtonEnble?Colors.grey:Colors.transparent,
															child: Text(
																_sendButtonText,
																style: TextStyle(
																	fontSize: ScreenUtil().setSp(34),
																	color: _sendButtonEnble?Colors.white:Colors.black.withOpacity(0.4)
																),
															),
					...
					child: Container(
						...
						decoration: BoxDecoration(
							gradient: LinearGradient( //背景径向渐变
								colors: [Color.fromRGBO(42, 192, 255, 1),Color.fromRGBO(35, 177, 250, 1), Color.fromRGBO(21, 145, 241, 1)],
						...
						child: FlatButton(
							onPressed: (){
								...
								if(_selectIndex==0){
									model.login(this._accountName, this._password)
									.then((value) {
										if (value) {
									...
									model.phoneLogin(this._phoneNumber, this._checkCode)
									.then((value) {
										if (value) {
											Navigator.of(context).pushReplacementNamed(RouteName.tab);
										} else {
		...
		return new Container(
			...
			decoration: BoxDecoration(
				border:Border(
					bottom: BorderSide(
						width: 1,
						color: index==_selectIndex?Color.fromRGBO(0, 104, 216, 1):Color.fromRGBO(190, 190, 190, 1)
					)
				),
			),
			child: FlatButton(
	...
	Widget _inputItem({TextInputType keyType=TextInputType.text,String imgStr,String hintText,Function change,bool hideText=false,Widget suffix}){
		//print(suffix);
		return new Container(
